module.exports = {
  ...
  ARCHIVE_DATABASE_USERNAME: process.env.WMT_ARCHIVE_MIGRATION_DATABASE_USERNAME || 'wmt',
  ARCHIVE_DATABASE_PASSWORD: process.env.WMT_ARCHIVE_MIGRATION_DATABASE_PASSWORD || 'wmt',
